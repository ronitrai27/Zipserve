      ...
      <div className="flex flex-row -ml-20">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileTap="whileTap"
            className="rounded-xl -mr-4 mt-4 p-1 bg-white dark:bg-neutral-800 dark:border-neutral-700 border border-gray-200 border-neutral-100 flex-shrink-0 overflow-hidden dark:border-gray-800">
            <Image
              src={image}
              alt="bali images"
              width="500"
