  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      const response = await axios.post(
        ...
        { name, email, phone, password: pass }, // Send form data
      ...
      <div className="min-w-[36%] max-w-[38%] px-4 py-6">
        ...
        <div className=" flex flex-col justify-center h-full ">
          <h1 className="text-[30px] text-black font-medium tracking-tight capitalize px-8 leading-8 mb-2 text-center">
            <span className="text-primary text-[34px]">register</span> and avail
            huge <span className="italic text-gray-500 ">discounts</span> on
            bookings
          </h1>
          ...
          >
            ...
            <button
              type="submit"
              className="group relative cursor-pointer w-52 border bg-white rounded-full overflow-hidden text-black font-semibold hover:shadow-lg transition-shadow duration-300 mt-6"
